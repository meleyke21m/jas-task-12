...
//   function ElementById(users, id) {
//     let element = users.find(item => item.id === id);
//     if (element) {
    
//       localStorage.setItem(`element_${id}`, JSON.stringify(element));
//       console.log(`Element ID ${id} localStorage-ə əlavə edildi:`, element);
//     } else {
//       console.log(`Element ID ${id} tapılmadı.`);
//     }
//   }
...
// ElementById(users, randomID);
  
// 3) ele bir func qurun ki paremtr olaraq key verildiyinde gedib localstorageden
// hemin keye gore elementi silsin
// function localStorageElementSil(key) {
//     try {
//       if (localStorage.getItem(key)) {
//         localStorage.removeItem(key);
//         console.log(`Element açar ${key} ilə localStorage-dən silindi.`);
//       } else {
//         console.log(`Element açar ${key} ilə localStorage-də tapılmadı.`);
//       }
//     } catch (error) {
...
//   localStorageElementSil("element_1");
...
// let operator=["055", "085", "051", "075" ,"095", "050"];
// const updatedUsers=()=>{
//     try{
//         users.forEach((item)=>{
//             let newOperator=operator[randomNumberGenerater(operator.length)];
//             let randomNumber=`${randomNumberGenerater(10)}${randomNumberGenerater(10)}${randomNumberGenerater(10)}${randomNumberGenerater(10)}-${randomNumberGenerater(10)}${randomNumberGenerater(10)}`
...
//   let updatedUsers = updateUserPhones(users);
